...
<body style="white-space:nowrap">
  <div id="header">
    ...
    <div id="header_text">UCSC Academic & Publication Department</div>
  </div>
  ...
  <?php if(valueCheck('action','faculty')) : ?>
    ...
    <div class="box">
      ...
      <div class="title">Change User Access</div>
      <div class="elements">
        <form method="post" action="register.php?action=changeLevel">
          <select name="uName" id="fac_level" class="updateSelect stretch" data-placeholder="Choose User..." required>
    ...
    <div class="box">
      ...
      <div class="elements">
        <form method="post" action="register.php?action=deleteFaculty" class="confirm">
          <select name="uName" class="updateSelect stretch" data-placeholder="Choose User..." required>
            <option label="Choose User..."></option>
            <?php
            foreach($db->query('SELECT * FROM faculty') as $fac)
          ...
          <input type="hidden" id="confirm_msg" value="Are you sure you want to delete the selected User?">
          <div class="blocktext info"></div>
          <div class="center button">
  ...
  <?php else: ?>
    <div class="box">
      <div class="boxbg"></div>
      <div class="information"><div class="icon add"></div></div>
      <div class="title">Add Lecture Hall</div>
      <div class="elements">
        <form method="post" action="rooms.php?action=add">
          <input type="text" name="room_name" class="styled details" required pattern="[^:]{2,25}" title="2 to 25 alphanumeric characters" placeholder="Hall Name" />
    ...
    <div class="box">
      <div class="boxbg"></div>
      <div class="information"><div class="icon remove"></div></div>
      <div class="title">Delete Lecture Hall</div>
      <div class="elements">
        <form method="post" action="rooms.php?action=delete" class="confirm">
          <select name="room_name" class="updateSelect stretch"  data-placeholder="Choose Hall..." required>
          ...
          <div class="blocktext info"></div>
          <input type="hidden" id="confirm_msg" value="Are you sure you want to delete the selected Hall?">
          <div class="center button">
            <button>Delete</button>
          </div>
        </form>
